...
func (tx *Tx) init() {
	tx.ActiveSession = NewActiveSessionClient(tx.config)
	tx.Candle = NewCandleClient(tx.config)
}
...
// applies a query, for example: ActiveSession.QueryXXX(), the query will be executed

...
// First returns the first Candle entity from the query.
// Returns a *NotFoundError when no Candle was found.
func (cq *CandleQuery) First(ctx context.Context) (*Candle, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{candle.Label}
	}
	return nodes[0], nil
}
...
// Only returns a single Candle entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one Candle entity is found.
// Returns a *NotFoundError when no Candle entities are found.
func (cq *CandleQuery) Only(ctx context.Context) (*Candle, error) {
	...
	case 0:
		return nil, &NotFoundError{candle.Label}
	default:
		return nil, &NotSingularError{candle.Label}
	}
}
...
func (cq *CandleQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{candle.Label}
	default:
		err = &NotSingularError{candle.Label}
	}
	return
}
...
func (cq *CandleQuery) All(ctx context.Context) ([]*Candle, error) {
	...
	qr := querierAll[[]*Candle, *CandleQuery]()
	return withInterceptors[[]*Candle](ctx, cq, qr, cq.inters)
}
...
func (cq *CandleQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = cq.Select(candle.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (cq *CandleQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, cq, querierCount[*CandleQuery](), cq.inters)
}
...
// Clone returns a duplicate of the CandleQuery builder, including all associated steps. It can be
...
func (cq *CandleQuery) Clone() *CandleQuery {
	...
	return &CandleQuery{
		config:     cq.config,
		ctx:        cq.ctx.Clone(),
		order:      append([]candle.OrderOption{}, cq.order...),
		inters:     append([]Interceptor{}, cq.inters...),
		predicates: append([]predicate.Candle{}, cq.predicates...),
...
func (cq *CandleQuery) GroupBy(field string, fields ...string) *CandleGroupBy {
	...
	grbuild := &CandleGroupBy{build: cq}
	grbuild.flds = &cq.ctx.Fields
	grbuild.label = candle.Label
...
func (cq *CandleQuery) Select(fields ...string) *CandleSelect {
	...
	sbuild := &CandleSelect{CandleQuery: cq}
	sbuild.label = candle.Label
...
func (cq *CandleQuery) prepareQuery(ctx context.Context) error {
...
func (cq *CandleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Candle, error) {
	var (
		nodes = []*Candle{}
		_spec = cq.querySpec()
	)
	_spec.ScanValues = func(columns []string) ([]any, error) {
		return (*Candle).scanValues(nil, columns)
	}
	_spec.Assign = func(columns []string, values []any) error {
		node := &Candle{config: cq.config}
...
func (cq *CandleQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := cq.querySpec()
...
func (cq *CandleQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(cq.driver.Dialect())
	t1 := builder.Table(candle.Table)
	columns := cq.ctx.Fields
	if len(columns) == 0 {
		columns = candle.Columns
	}
...
func (cgb *CandleGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*CandleQuery, *CandleGroupBy](ctx, cgb.build, cgb, cgb.build.inters, v)
}

func (cgb *CandleGroupBy) sqlScan(ctx context.Context, root *CandleQuery, v any) error {
...
func (cs *CandleSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*CandleQuery, *CandleSelect](ctx, cs.CandleQuery, cs, cs.inters, v)
}

func (cs *CandleSelect) sqlScan(ctx context.Context, root *CandleQuery, v any) error {
